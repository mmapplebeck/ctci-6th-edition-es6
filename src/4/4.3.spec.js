...
import {toLinkedLists, toLinkedListsRecursive} from './4.3'
...
describe('4.3', () => {
  ...
  const testMethod = method => {
    ...
    expect(method(node3)).toEqual(expected)
  }

  describe('toLinkedLists()', () => {

    it('should return binary tree levels as linked lists', () => {
      testMethod(toLinkedLists)
    })
  })

  describe('toLinkedListsRecursive()', () => {

    it('should return binary tree levels as linked lists', () => {
      testMethod(toLinkedListsRecursive)
    })
  })
})